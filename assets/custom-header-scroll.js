function updateHeaderBasedOnScrollOffset() {
...
window.addEventListener('scroll', updateHeaderBasedOnScrollOffset);
window.addEventListener('load', updateHeaderBasedOnScrollOffset);
